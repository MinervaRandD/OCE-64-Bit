    ...
    public partial class ImageReplacerForm : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string extension = Path.GetExtension(replacementImage);

                if (extension != ".png" && extension != ".jpeg" && extension != ".jpg")
                {
                    MessageBox.Show("The replacement image must be of png or jpeg (extension '.png', '.jpg' or '.jpeg')");
                    return;
                }
                ...
                string fileToReplace = @"C:\OCEOperatingData\Workspace\image1" + extension;
                ...
                string imageToReplace = @"C:\OCEOperatingData\Workspace\TempArchive\visio\media\image1" + extension;

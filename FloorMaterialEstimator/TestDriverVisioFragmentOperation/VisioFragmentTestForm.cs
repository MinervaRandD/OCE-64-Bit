...
namespace TestDriverVisioFragmentOperation
{
    using System;
    ...
    public partial class VisioFragmentTestForm : Form
    {
        ...
        private void doLayoutAreaDivide()
        {
            ...
            List<Shape> dividedElementList = graphicsLayoutArea.Divide(window, page, new List<Coordinate>() { coord1, coord2 });
        ...
        private void doDivide()
        {
            ...
            List<Shape> dividedShapeList = VisioGeometryEngine.Subdivide(window, page, shape, shapeLinePoints);
        }

...
/*******************************************************************************************************/
/*                                                                                                     */
/* File: IGraphicsShape.cs. Project: Graphics. Created: 6/10/2024         */
/*                                                                                                     */
...
namespace Graphics
{
    public interface IGraphicsShape
    {
        GraphicShape Shape { get; set; }

        GraphicsWindow Window { get; set; }

        GraphicsPage Page { get; set; }

        ShapeType ShapeType { get; }

        string Guid { get; }

        GraphicsLayerBase GraphicsLayer { /*get;*/ set; }

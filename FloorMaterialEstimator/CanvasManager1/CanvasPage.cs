...
namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public class CanvasPage: GraphicsPage
    {
        ...
        public CanvasPage(CanvasManager canvasManager, GraphicsWindow window, Visio.Page visioPage): base(window, visioPage)
        {
        ...
        public override double DrawingScaleInInches
        {
            ...
            set
            {
                ...
                SystemState.BtnSetCustomScale.Image = CanvasManager.BaseForm.CustomScaleLineColoredImage;
                CanvasManager.BaseForm.btnTapeMeasure.Enabled = true;
        ...
        public bool ScaleHasBeenSet
        {
            ...
            set
            {
                ...
                if (value == true)
                {
                    BaseForm.tssDrawoutLength.Text = string.Empty;
                }

                else
                {
                    BaseForm.tssDrawoutLength.Text = "<No Scale Set>";
                }
            }
        }
        ...
        internal void SetDefaultScale(double drawingScaleInInches)
        {
            ...
            SystemState.BtnSetCustomScale.Image = CanvasManager.BaseForm.CustomScaleLineUncoloredImage;
            CanvasManager.BaseForm.btnTapeMeasure.Enabled = false;

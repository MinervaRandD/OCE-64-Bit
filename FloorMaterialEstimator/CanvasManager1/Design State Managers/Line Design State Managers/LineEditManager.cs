...
namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public partial class CanvasManager
    {
        ...
        public void ProcessEditLineModeActionDeleteLine(CanvasDirectedLine canvasDirectedLine)
        {
            ...
            {
                MessageBox.Show("The currently selected line is a boundary of finish area and cannot be independently deleted");
                return;
            }
        ...
        //    CurrentPage.UpdateLineDesignStateAreaSelectionStatus(selectedCanvasDirectedLine);
        //}
        ...
        public void ProcessEditLineUndo()
        {
            ...
            foreach (CanvasDirectedLine line in DeletedLineShapes)
            {
                ...
                //if (BaseForm.ckbEditLineHighlightAndApply.Checked)
                //{
                //    CurrentPage.UpdateLineDesignStateAreaSelectionStatus(line);
                //}
            }
            ...
            foreach (Tuple<LineFinishManager, CanvasDirectedLine> line in MovedLineShapes)
            {
                ...
                //if (BaseForm.ckbEditLineHighlightAndApply.Checked)
                //{
                //    CurrentPage.UpdateLineDesignStateAreaSelectionStatus(line.Item2);
                //}
            }
        ...
        internal void DeleteSelectedLines(bool deleteSingleLines, bool deleteDoubleLines, bool deleteAreaModeLines)
        {
            ...
            foreach (CanvasDirectedLine directedLine in CurrentPage.DirectedLines)
            {
                ...
                else if (directedLine.LineCompoundType == LineCompoundType.Double && deleteDoubleLines)
                {
                    linesToDelete2X.Add(directedLine);
                }

                else if (directedLine.Shape.Data1 == "Associated Line" && deleteAreaModeLines)
                {

...
namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public partial class CanvasManager
    {
            ...
            else
            {
                if (LayoutAreaForSubdivision.IsSeamed() || LayoutAreaForSubdivision.SeamDesignStateSelectionModeSelected)
                {
                    DialogResult dr = MessageBox.Show(
                        "This area is either seamed or selected for seaming in area selection mode. Continuing will reset this area in area selection mode and select it subdivision. Do you want to continue?"
                    ...
                    CurrentPage.UpdateSeamDesignStateAreaSelectionStatus(LayoutAreaForSubdivision, FinishGlobals.SelectedAreaFinish.Guid, x, y);
                }
        ...
        public void ContinueSubdivisionDraw(double x, double y)
        {
            ...
            {
                MessageBox.Show("Please select an area for subdivision");
                return;
            }
        ...
        public void SelectAreaForMerging(double x, double y)
        {
            ...
            {
                MessageBox.Show("Cannot merge this area: it is further subdivided.");
            ...
            {
                MessageBox.Show("Cannot merge this area: it is a top level layout area.");
            ...
            foreach (CanvasLayoutArea canvasLayoutArea in parentLayoutArea.OffspringAreas)
            {
                ...
                {
                    MessageBox.Show("Cannot merge this area: at least one sibling is further subdivided.");
            ...
            {
                MessageBox.Show("This area does not have any siblings for merging");
            ...
            DialogResult dr = MessageBox.Show("OK to merge areas in gray?", "Confirm Merge", MessageBoxButtons.OKCancel);
            ...
            foreach (CanvasDirectedLine externAreaLine in parentLayoutArea.ExternalArea)
            {
                ...
                externAreaLine.LineFinishManager.SeamDesignStateLayer.AddShapeToLayer(externAreaLine, 1);
            }
        ...
        private void setSubdividedAreasSelectionStatus(CanvasLayoutArea layoutAreaForSubdivision)
        {
            ...
            if (layoutAreaForSubdivision.SeamAreaIndex != 0)
            {
                ...
                foreach (CanvasLayoutArea canvasLayoutArea in layoutAreaForSubdivision.OffspringAreas)
                {
                    ...
                    CurrentPage.UpdateSeamDesignStateAreaSelectionStatus(canvasLayoutArea, layoutAreaForSubdivision.AreaFinishManager.Guid, location.X, location.Y);
                }
        ...
        public void ProcessSubdivisionPolylineCompleteShape(bool fromButtonClick = false)
        {
            ...
            {
                MessageBox.Show("At least 2 points must be selected to complete the current drawing.");
        ...
        private bool processSubdivideByLine(CanvasLayoutArea layoutAreaForSubdivision, CanvasDirectedPolyline polyline)
        {
            ...
            try
            {
                ...
                List<Shape> subdivideShapeList = layoutAreaForSubdivision.Divide(Window, Page, polyline.GetCoordinateList());
        ...
        private void completeSubdivisionProcess(CanvasLayoutArea layoutAreaForSubdivision)
        {
            ...
            if (layoutAreaForSubdivision.ParentArea is null)
            {
                ...
                Shape shape = layoutAreaForSubdivision.DrawCompositeShape(Window, Page, true); // Draw a new version (put it back) on the canvas because visio subdivide will have removed it.
            ...
            else
            {
                ...
                Page.InvisibleWorkspaceLayer.AddShapeToLayer(layoutAreaForSubdivision, 1);
            ...
            foreach (CanvasDirectedLine externalAreaLine in layoutAreaForSubdivision.ExternalArea)
            {
                ...
                Page.InvisibleWorkspaceLayer.AddShapeToLayer(externalAreaLine, 1); // Makes the lines invisible since not needed.
            }
            ...
            foreach (CanvasDirectedPolygon internalArea in layoutAreaForSubdivision.InternalAreas)
            {
                foreach (CanvasDirectedLine internalAreaLine in internalArea)
                {
                    ...
                    Page.InvisibleWorkspaceLayer.AddShapeToLayer(internalAreaLine, 1); // Makes the lines invisible since not needed.
                }
            }

...
namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public partial class CanvasManager
    {
        ...
        bool showUnseamedAreas = false;

        bool showZeroAreas = false;
        ...
        public void doProcessKeyDown(int keyVal, KeyModifiers modifiers = KeyModifiers.None)
        {
            if (keyVal == 27) // Escape
            {
                StaticGlobals.ActivateTapeMeasure();
        ...
        private void ProcessDeleteCommand()
        {
            ...
            if (DesignState == DesignState.Line)
            {
                ...
                if (areaLinesFound)
                {
                    MessageBox.Show("One or more lines could not be deleted because they belong to an area.");
                }
            }
        ...
        private void ProcessShortcutKey(int keyVal)
        {
            ...
            if (DesignState == DesignState.Area)
            {
                ...
                switch (shortcutNumber)
                {
                    ...
                    case 4: ProcessAreaModeDeleteBuildingLine(); return;
                    case 5: ProcessAreaModeCancelShapeInProgress(); return;
                    case 6: ProcessDeleteCommand(); return;
                    case 7: ProcessAreaModeToggleZeroLineMode(); return;
                    case 8: ProcessAreaModeTakeout();  return;
                    case 9: ProcessAreaModeTakeoutAndFill(); return;
                    case 10: ProcessAreaModeEmbedShape(); return;
                    case 11: ProcessAreaModeCopyAndShape(); return;
                    case 12: ProcessAreaModeToggleFixedWidth(); return;
                    case 13: ProcessAreaModeFixedWidthJump(); return;
                    case 14: return;
                    case 15: return;
        ...
        {
            if (BaseForm.btnFixedWidthJump.Enabled)
            {
                BaseForm.BtnFixedWidthJump_Click(null, null);
            }
        }
        ...
        {
            BaseForm.BtnLayoutLineActivate_Click(null, null);
        }

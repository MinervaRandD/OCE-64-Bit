namespace CanvasManager.CanvasShapes
{
    ...
    {
        public void SelectForSubdivision()
        {
            //if (ParentArea != null)
            //{
        ...
        public void DeselectForSubdivision()
        {
        ...
        public bool SubdivideByLine(CanvasDirectedPolyline polyline)
        {
            ...
            foreach (Shape shape in subdivideShapeList)
            {
                ...
                // public maintenance. Normally, it would be the other way around: The layout area is constructed first and then drawn onto the canvas.

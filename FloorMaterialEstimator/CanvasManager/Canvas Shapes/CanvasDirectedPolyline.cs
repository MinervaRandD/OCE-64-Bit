...
namespace CanvasManager.CanvasShapes
{
    ...
    public class CanvasDirectedPolyline : List<CanvasDirectedLine>
    {
        ...
        private Color currentLineColor => FinishManagerGlobals.SelectedLineFinishManager.LineColor;

        public AreaModeStartMarker StartMarker;

        public CanvasDirectedPolyline(
        ...
        public void Delete()
        {
            ...
            {
                if (!Page.PageShapeDictContains(line.Shape))
                {
        ...
        public bool ValidateNoIntersection(double x, double y)
        {
            if (this.Count <= 0)
            {
                return true;
        ...
        public void AutofillFromGuides(double x, double y, int finishIndex)
        {
            double? xMin = null;
            double? xMax = null;
            double? yMin = null;
            ...
            FieldGuideGlobals.FieldGuideController.GetBoundingGuides(x, y, out xMin, out xMax, out yMin, out yMax);
            ...
            SystemGlobals.CompletePolylineDraw(finishIndex);

        }

        public bool AutoCompleteFromGuides(double x, double y, int finishIndex)
        {
            double? xMin = null;
            double? xMax = null;
            double? yMin = null;
        ...
        private void resetAutoFillFromGuides()
        {
            ...
            CanvasPage.BuildingPolyline = null;
        ...
        public CanvasDirectedLine RemoveLastLine()
        {
            ...
            {
                CanvasPage.RemoveMarkerAndGuides();
        ...
        public Coordinate GetFrstCoordinate()
        {
            if (CoordList.Count <= 0)
            {
        ...
        private void InsertLine(Coordinate coord1, Coordinate coord2, int index)
        {
            ...
            CanvasDirectedLine canvasDirectedLine = new CanvasDirectedLine(
                ...
                , new GraphicsDirectedLine(Window, Page, new DirectedLine(coord1, coord2), LineRole.ExternalPerimeter)
                , SystemState.DesignState)
            {
                LineStartCursorPosition = SystemGlobals.GetCursorPosition(),
                IsZeroLine = SystemState.ZeroLineState
            };
            ...
            canvasDirectedLine.ucLine = PalettesGlobal.LineFinishPalette.SelectedLine;

            FinishManagerGlobals.SelectedLineFinishManager.AddLine(canvasDirectedLine);
        ...
        public void AddExtendingLineFromGuides(double x, double y)
        {
            ...
            if (!FieldGuideGlobals.FieldGuideController.GetClosestGuides(x, y, out guideX, out guideY, GlobalSettings.SnapDistance, 0))
            {
        ...
        private void AddCompletingLine(Coordinate coord1, Coordinate coord2)
        {
            ...
            SystemGlobals.CompletePolylineDraw(0);
        }
        ...
        private bool getHorizontalLineBounds(double x, double y, out Coordinate coord1, out Coordinate coord2)
        {
            ...
            double? xMin = FieldGuideGlobals.FieldGuideController.GetLeftGuideLineX(x);
            ...
            double? xMax = FieldGuideGlobals.FieldGuideController.GetRghtGuideLineX(x);
        ...
        private bool getVerticalLineBounds(double x, double y, out Coordinate coord1, out Coordinate coord2)
        {
            ...
            double? yMin = FieldGuideGlobals.FieldGuideController.GetLowrGuideLineY(y);
            ...
            double? yMax = FieldGuideGlobals.FieldGuideController.GetUpprGuideLineY(y);
        ...
        public void ValidateConsistentPerimeter()
        {
        ...
        //public void CreateInternalAreaShape()
        //{
        ...
        public void SetupMarkerAndGuides()
        {
            ...
            CanvasPage.SetupMarkerAndGuides(coord);
        }

...
namespace CanvasManager.CanvasShapes
{
    ...
    public class CanvasDirectedLine: GraphicsDirectedLine, IGraphicsShape
    {
            ...
            , CanvasDirectedLine line)
        {
            ...
            UCLineFinishPalette linePalette = PalettesGlobal.LineFinishPalette;

            ucLine = PalettesGlobal.LineFinishPalette[line.Guid];

            LineFinishManager = FinishManagerGlobals.LineFinishManagerList[line.Guid];
        ...
        public GraphicShape Shape => base.Shape;
        ...
        public GraphicShape Draw(Color lineColor, double lineWidthInPts = 3)
        {
            ...
            if (IsZeroLine)
            {
                SetBaseLineStyle(SystemGlobals.ZeroLineStyleFormula);
            }
        ...
        public void SetBaseLineStyle(AreaShapeBuildStatus buildStatus)
        {
            ...
            {
                SetBaseLineWidth(SystemGlobals.CompletedShapeLineWidthInPts);
            }
        ...
        private void SetLineGraphicsForAreaDesignState(AreaShapeBuildStatus buildStatus)
        {
            ...
            else
            {
                ...
                SetBaseLineStyle(SystemGlobals.AreaModePerimeterLineStyleFormula);

                SetBaseLineColor(SystemGlobals.AreaModePerimeterLineColor);
            }
            ...
            if (buildStatus == AreaShapeBuildStatus.Completed)
            {
                if (this.ParentPolygon is null && this.LineCompoundType == LineCompoundType.Double)
                {
                    ...
                    SetBaseLineWidth(12 * SystemGlobals.CompletedShapeLineWidthInPts);
                }
        ...
        /// <returns></returns>
        public new CanvasDirectedLine ExtendStart(double extensionLength)
        {
            return new CanvasDirectedLine(Window, Page, this.LineFinishManager, base.ExtendStart(extensionLength), SystemState.DesignState);
        }

        public new  CanvasDirectedLine ExtendEnd(double extensionLength)
        {
            return new CanvasDirectedLine(Window, Page, this.LineFinishManager, base.ExtendEnd(extensionLength), SystemState.DesignState);
        }
        ...
        public void Redraw(DesignState lineArea, bool selected, AreaShapeBuildStatus areaBuildStatus)
        {
        ...
        public bool IsValidLineForSeamSelection()
        {
            ...
            if (ParentLayoutArea.AreaFinishManager.Guid != PalettesGlobal.AreaFinishPalette.SelectedFinish.Guid)
            {
                return false;
            }
        ...
        {
            CurrentPage.SetLineDesignStateAreaSelectionStatus(this, isSelected);
        }

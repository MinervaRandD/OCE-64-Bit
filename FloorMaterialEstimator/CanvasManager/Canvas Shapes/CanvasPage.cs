...
namespace CanvasManager.CanvasShapes
{
    ...
    public class CanvasPage: GraphicsPage
    {
        ...
        public Dictionary<string, CanvasSeam> GetSeamDictionary(AreaFinishManager selectedAreaFinishManager)
        {
        ...
        public List<CanvasSeam> GetSeamList(AreaFinishManager selectedAreaFinishManager)
        {
...
#region Borders
        ...
        public void PlaceGuides(double x, double y)
        {
        ...
        public CanvasLayoutArea GetSelectedLayoutArea(
            double x
            , double y
        ...
        public CanvasLayoutArea GetSelectedToplevelLayoutArea(
         double x
         , double y
         , MaterialsType materialType = MaterialsType.Any
         , LayoutAreaType layoutAreaType = LayoutAreaType.Unknown)
        ...
        public CanvasLayoutArea GetContainingLayoutArea(Coordinate coord1, Coordinate coord2, Coordinate coord3, Coordinate coord4, bool allowSubdividedAreas = false)
        {
        ...
        public CanvasLayoutArea GetContainingLayoutArea(double x, double y)
        {
            return GetContainingLayoutArea(new Coordinate(x, y));
        }

        public CanvasLayoutArea GetContainingLayoutArea(Coordinate coord)
        {
        ...
        public CanvasLayoutArea GetContainingLayoutAreaMinusInternalArea(IEnumerable<CanvasLayoutArea> candidateLayoutAreas, Coordinate coord)
        {
        ...
        //public bool MouseOverSeamingTool(double x, double y, CanvasLib.SeamingTool.SeamingTool seamingTool)
        //{
        ...
        public List<CanvasLayoutArea> GetSelectedAreaShapeList(
            double x
            , double y
        ...
        public CanvasDirectedLine GetSelectedLineShape(double x, double y)
        {
        ...
        public List<CanvasDirectedLine> GetSelectedLineShapeList(Coordinate coordinate)
        {
            return GetSelectedLineShapeList(coordinate.X, coordinate.Y);
        }

        public List<CanvasDirectedLine> GetSelectedLineShapeList(double x, double y)
        {
        ...
        public IGraphicsShape GetSelectedCutOverOrUnderIndexShape(double x, double y)
        {
            Visio.Selection selection = VisioPage.SpatialSearch[
               x, y,
               (short)(
        ...
        public List<CanvasSeam> GetSelectedSeamList(Coordinate coordinate, Dictionary<string, CanvasSeam> seamDict)
        {
            return GetSelectedSeamList(coordinate.X, coordinate.Y, seamDict);
        }

        public List<CanvasSeam> GetSelectedSeamList(double x, double y, Dictionary<string, CanvasSeam> seamDict)
        {
        ...
        public List<CanvasSeam> GetSelectedSeams()
        {
            List<CanvasSeam> rtrnList = new List<CanvasSeam>();
        ...
        public List<IGraphicsShape> GetShapeList()
        {
        ...
        public void SetDefaultScale(double drawingScaleInInches)
        {

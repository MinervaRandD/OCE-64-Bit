...
namespace CanvasManagerLib.FinishManager
{
    ...
    public class AreaFinishManagerList : List<AreaFinishManager>, IDisposable
    {
            ...
            , AreaFinishBaseList areaFinishBaseList)
        {
            ...
            {
                AreaFinishManager areaFinishManager = new AreaFinishManager(canvasWindow, canvasPage, areaFinishBaseList, areaFinishBase);
        ...
        {
            SetDesignStateFormat(currentDesignState, SystemState.SeamMode, SystemState.ShowAreas);
        }

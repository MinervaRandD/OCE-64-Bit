...
namespace CanvasManagerLib.FinishManager
{
    ...
    public class AreaFinishManager : IDisposable
    {
        ...
        private GraphicsWindow canvasWindow { get; }

        private GraphicsPage canvasPage { get; }
        ...
        //public GraphicsLayerBase SeamStateLockLayer => AreaFinishLayers.SeamDesignStateLockLayer;
        ...
        public void RemoveLayoutArea(CanvasLayoutArea canvasLayoutArea)
        {
            ...
            {
                this.AreaPerimeterLayer.RemoveShapeFromLayer(perimeterLine, 1);
            }
        }
        ...
        public void UpdateStats()
        {
            ...
            {
                StatsGeneratorLib.AreaStatsCalculator areaStatsCalculator = new AreaStatsCalculator(canvasPage.DrawingScaleInInches, AreaFinishBase.RollWidthInInches, AreaFinishBase.NetAreaInSqrInches);
        ...
        private double? calculateRollWasteFactor(double netAreaInSqrInches, double perimeterInInches)
        {
            ...
            StatsCalculators.RolloutStatsCalculator rolloutStatsCalculator = new StatsCalculators.RolloutStatsCalculator(this.canvasPage, AreaFinishBase);
        ...
        public AreaFinishManager(
            GraphicsWindow canvasWindow
            , GraphicsPage canvasPage
            ...
            , AreaFinishBase areaFinishBase)
        {
            ...
            this.AreaFinishLayers = new AreaFinishLayers(canvasWindow, canvasPage, areaFinishBase.AreaName);
        }
        ...
        {
            StatsCalculators.RolloutStatsCalculator rolloutStatsCalculator = new StatsCalculators.RolloutStatsCalculator(canvasPage, AreaFinishBase);
        ...
        public void UpdateBaseColor(Color updtColor)
        {
            ...
            else
            {
                foreach (CanvasLayoutArea canvasLayoutArea in CanvasLayoutAreas)
                {
                    canvasLayoutArea.SetPatternFillColor(visioFillColorFormula);
                }
            }
        }
        ...
        {
            double transparency = 100.0 - Math.Max(Math.Min(100.0, 100.0 * opacity), 0.0);

            string visioFillTransparencyFormula = transparency.ToString("0.0000") + "%";
            ...
            else
            {
                foreach (CanvasLayoutArea canvasLayoutArea in CanvasLayoutAreas)
                {
                    canvasLayoutArea.SetPatternFillTransparancy(visioFillTransparencyFormula);
                }
            }
        }
        ...
        public void SetupSeamModeDesignState(string selectedFinishGuid)
        {
            ...
            foreach (CanvasLayoutArea layoutArea in CanvasLayoutAreas)
            {
                ...
                layoutArea.SetLineGraphics(
                    ...
                    layoutArea.SeamDesignStateSelectionModeSelected && (layoutArea.AreaFinishManager.Guid == selectedFinishGuid), CanvasManager.AreaShapeBuildStatus.Completed);
        ...
        internal void AddNormalLayoutAreaAreaStateOnly(CanvasLayoutArea canvasLayoutArea, bool updateColor = true)
        {
           ...
           // this.AreaDesignStateLayer.AddShape(canvasLayoutArea, 1);
        ...
        internal void AddNormalLayoutArea(CanvasLayoutArea canvasLayoutArea, bool recursive = true, bool updateColor = true)
        {
            ...
            this.SeamDesignStateLayer.AddShape(canvasLayoutArea, 1);
            this.AreaDesignStateLayer.AddShape(canvasLayoutArea, 1);

            foreach (var perimeterLine in canvasLayoutArea.Perimeter)
            {
                this.AreaPerimeterLayer.AddShape(perimeterLine, 1);
            }
        ...
        public void Delete()
        {
            canvasPage.RemoveFromGraphicsLayerDict(SeamDesignStateLayer.GetBaseLayer());

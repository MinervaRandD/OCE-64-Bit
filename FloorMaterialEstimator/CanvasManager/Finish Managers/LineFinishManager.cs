...
using PaletteLib;
using TracerLib;
using CanvasManager.CanvasShapes;
...
#region Layers
        ...
        //public IEnumerable<CanvasDirectedLine> CanvasLayoutAreas => CanvasDirectedLineDict.Values;
            ...
            , LineFinishBase lineFinishBase)
        {
            ...
            this.LineFinishLayers = new LineFinishLayers(canvasWindow, canvasPage, lineFinishBase.LineName);
        ...
        private void LineFinishBase_LineColorChanged(LineFinishBase LineFinishBase, System.Drawing.Color lineColor)
        {
            foreach (DoorTakeout doorTakeout in DoorTakeoutList)
            {
                ...
                VisioInterop.SetShapeText(doorTakeout.Shape, doorTakeout.TakeoutAmount.ToString("0.0"), lineColor, 10);
            }
        }
        ...
        internal void UpdateFinishStats()
        {
            ...
            double scale = canvasPage.DrawingScaleInInches;
        ...
        internal void AddLineFull(CanvasDirectedLine line, bool updateColor = true)
        {
           ...
           // Visio.Shape visioShape = line.Shape.VisioShape;
            ...
            if (line.OriginatingDesignState == DesignState.Area || line.OriginatingDesignState == DesignState.Seam)
            {
                ...
                if (line.IsZeroLine)
                {
                    line.SetBaseLineStyle(SystemGlobals.ZeroLineStyleFormula);
                }
            }
        ...
        public void AddLineToLayer(string guid, DesignState designState, SeamMode seamMode)
        {
            ...
            switch (designState)
            {
                case DesignState.Area: AreaDesignStateLayer.AddShape(canvasDirectedLine, 1); return;
                case DesignState.Line: LineDesignStateLayer.AddShape(canvasDirectedLine, 1); return;

...
namespace OversUndersLib
{
    class LoadStartingOUsX // Now loaded from driver input
    {
        ...
        public static void LoadInputOUs(MainNonXAML mainNonXAML) // no references found
        {
        ...
        {
            string[] linesOW = File.ReadAllLines(Globals.filePath[0]);
            string[] linesOL = File.ReadAllLines(Globals.filePath[1]);
            int i = 0;
            ...
            string[] linesUW = File.ReadAllLines(Globals.filePath[2]);
            string[] linesUL = File.ReadAllLines(Globals.filePath[3]);
            i = 0;

...
namespace OversUndersLib
{
    public class FuncsX
    {
        ...
        public string FormatOU(int index, double width, double length)
        {
        ...
        public string DblToStr(double width)
        {
        ...
        public Double FRem(double d)
        {
            double t = 0;
            if (d > 0)
            {
                double j = Math.Truncate(Globals.rollWidth / d);
        ...
        public Double TotalCutLength(MainNonXAML mainNonXAML)
        {

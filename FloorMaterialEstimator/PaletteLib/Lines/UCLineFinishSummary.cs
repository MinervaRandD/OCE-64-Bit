...
namespace PaletteLib
{
    ...
    {
        private LineFinishBase _lineFinishBase = null;

        public LineFinishBase LineFinishBase
        {
            get
            {
                if (_lineFinishBase != null)
                {
                    return _lineFinishBase;
                }
        ...
        public void SetLineFinish(int selectedIndex)
        {
            ...
            LineFinishBase = FinishGlobals.LineFinishBaseList[selectedIndex];

            this.lblLineName.Text = this.LineFinishBase.LineName;

            double lengthInInches = FinishGlobals.LineFinishBaseList.SelectedItem.LengthInInches;

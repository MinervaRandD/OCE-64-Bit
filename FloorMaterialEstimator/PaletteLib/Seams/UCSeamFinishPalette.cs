...
namespace PaletteLib
{
    ...
    public partial class UCSeamFinishPalette : UserControl
    {
        ...
        public void Init(AreaFinishBaseList areaFinishBaseList)
        {
            ...
            {
                if (ucSeamAreaFinish.AreaFinishBase.MaterialsType == MaterialsType.Rolls && ucSeamAreaFinish.AreaFinishBase.NetAreaInSqrInches > 0)
                {
        ...
        public void UpdateSeamAreaPalette()
        {
            this.ucFlowLayoutPanel.Controls.Clear();
        ...
        private HashSet<SeamFinishBase> usedSeamFinishes()
        {
            ...
            foreach (AreaFinishBase areaFinishBase in FinishGlobals.AreaFinishBaseList)
            {
        ...
        {
            foreach (var seamFinishBase in FinishGlobals.SeamFinishBaseList)
            {
                seamFinishBase.Filtered = false;
            }
        }
    }
}

...
namespace FloorMaterialEstimator.Models
{
    ...
    public class Line
    {
        ...
        public double Length
        {
            get
            {
                return MathUtils.H2Length(Coord1, Coord2);
            }
        }
        ...
        internal double XInterceptForY(double y)
        {
            double x1 = Coord1.X;
            double x2 = Coord2.X;
        ...
        internal bool FallsBetween(double y1, double y2)
        {
            return Coord1.Y > y2 && Coord1.Y < y1 && Coord2.Y > y2 && Coord2.Y < y1;
        }

        internal bool HasPointsBelow(double y)
        {
            return Coord1.Y < y || Coord2.Y < y;
        }

        internal bool HasPointsAbove(double y)
        {
            return Coord1.Y > y || Coord2.Y > y;
        }

        internal double NormalizedAtan()
        {

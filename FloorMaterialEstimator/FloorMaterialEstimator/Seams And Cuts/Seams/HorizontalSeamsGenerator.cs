...
namespace FloorMaterialEstimator.Seams_And_Cuts
{
    ...
    public class HorizontalSeamsGenerator
    {
        ...
        public HorizontalSeamsGenerator(List<Line> perimeter)
        {
        ...
        private List<Seam> generateIntersectingSeamLines(double y, bool includeBoundaries = false)
        {
            ...
            for (int i = 0; i < intersectionList.Count; i += 2)
            {
                ...
                Seam seam = new Seam(coord1, coord2, line1Index, line2Index);
        ...
        private SortedList<Tuple<double, double>, int> generateIntersectingPoints(List<Line> transformedPerimeter, double y, bool includeBoundaries = false)
        {
            ...
            {
                Line line1 = transformedPerimeter[i];
                ...
                if (!includeBoundaries)
                {
                    ...
                    Debug.Assert(line2.Coord2.Y != y, "Invalid state");
                }
        ...
        private Line GetNextNoneZeroSlopeLineInSequence(List<Line> transformedPerimeter, int i)
        {
            int iStart = i;
            int count = transformedPerimeter.Count;
            ...
            {
                Line line = transformedPerimeter[iNext];

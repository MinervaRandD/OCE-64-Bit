...
namespace CanvasShapes
{
    ...
    public class CanvasDirectedPolyline : List<CanvasDirectedLine>
    {
        ...
        internal void Delete()
        {
            ...
            {
                if (!CanvasPage.PageShapeDictContains(line))
                {
                ...
                {
                    CanvasPage.RemoveFromPageShapeDict(line);
                }
        ...
        {
            return Perimeter.Sum(l => l.Length) * CanvasPage.DrawingScaleInInches;
        }
        ...
        internal void AutofillFromGuides(double x, double y, int finishIndex)
        {
            ...
            CanvasWindow.PolylineManager.CompletePolylineDraw(finishIndex);
        ...
        {
            return VisioInterop.GetShapeArea(PolygonInternalArea) * Math.Pow(CanvasPage.DrawingScaleInInches, 2.0);
        }
        ...
        private void InsertLine(Coordinate coord1, Coordinate coord2, int index)
        {
            ...
            CanvasDirectedLine canvasDirectedLine = new CanvasDirectedLine(
                ...
                , new GraphicsDirectedLine(this.CanvasWindow, this.CanvasPage, new DirectedLine(coord1, coord2), LineRole.ExternalPerimeter)

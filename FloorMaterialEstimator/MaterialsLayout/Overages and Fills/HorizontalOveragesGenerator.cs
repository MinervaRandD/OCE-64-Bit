...
namespace MaterialsLayout
{
    ...
    public class HorizontalOverageGenerator
    {
        ...
        private OverageLineSegment getStartOverageLineSegment()
        {
            ...
            if ((object) overageLineSegment != null)
            {
        ...
        OverageLineSegment getUpprStartLineSegment()
        {
            List<OverageLineSegment> ls = overageLineSegmentDict.Values.
                Where(l => l.Coord1.Y == upprBound && l.Coord2.Y == upprBound).ToList();
        ...
        {
            List<OverageLineSegment> ls = overageLineSegmentDict.Values.
                 Where(l => l.Coord1.X == rghtBound && l.Coord2.X == rghtBound).ToList();
        ...
        {
            List<OverageLineSegment> ls = overageLineSegmentDict.Values.
                 Where(l => l.Coord1.Y == lowrBound && l.Coord2.Y == lowrBound).ToList();
        ...
        {
            List<OverageLineSegment> ls = overageLineSegmentDict.Values.
                 Where(l => l.Coord1.X == leftBound && l.Coord2.X == leftBound).ToList();

...
/*******************************************************************************************************/
/*                                                                                                     */
/* File: VirtualCut.cs. Project: MaterialsLayout. Created: 6/10/2024         */
/*                                                                                                     */
...
{
    public class VirtualCut
    {
        public VirtualCut(double rollWidthInInches)
        {
            EffectiveDimensions = new Tuple<double, double>(0, rollWidthInInches);
        }

        public Tuple<double, double> EffectiveDimensions { get; set; } = new Tuple<double, double>(0, 0);

        public Tuple<double, double> OverrideEffectiveDimensions
        {
            get;
            set;
        } = null;

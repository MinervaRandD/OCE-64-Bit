...
namespace CanvasManagerLib
{
    ...
    public class CanvasPage: GraphicsPage
    {
        ...
        public void UpdateSelectedAreaColors(int colorIndex)
        {
            ...
            if (CanvasManager.layoutAreaForSubdivisionDict.ContainsKey(CanvasManager.BaseForm.selectedAreaFinish.Guid))
            {
                CanvasLayoutArea layoutAreaForSubdivision = CanvasManager.layoutAreaForSubdivisionDict[CanvasManager.BaseForm.selectedAreaFinish.Guid];
        ...
        public override double DrawingScaleInInches
        {
            ...
            set
            {
                ...
                CanvasManager.BaseForm.btnSetCustomScale.Image = CanvasManager.BaseForm.CustomScaleLineColoredImage;
        ...
        internal void SetDefaultScale(double drawingScaleInInches)
        {
            ...
            CanvasManager.BaseForm.btnSetCustomScale.Image = CanvasManager.BaseForm.CustomScaleLineUncoloredImage;

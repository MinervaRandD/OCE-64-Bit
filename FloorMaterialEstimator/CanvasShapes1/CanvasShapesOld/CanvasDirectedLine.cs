...
namespace CanvasManagerLib
{
    ...
    using CanvasLib.CanvasManagerLib;
    using Geometry;
    ...
    public class CanvasDirectedLine: GraphicsDirectedLine, IGraphicsShape
    {
        ...
        public CanvasDirectedLine(CanvasManager canvasManager, DirectedLineSerializable line)
        {
            ...
            UCLineFinishPalette linePalette = canvasManager.linePalette;
        ...
        internal bool IsValidLineForSeamSelection()
        {
            ...
            if (ParentLayoutArea.AreaFinishManager.Guid != this.canvasManager.areaPalette.SelectedFinish.Guid)
            {
                return false;
            }

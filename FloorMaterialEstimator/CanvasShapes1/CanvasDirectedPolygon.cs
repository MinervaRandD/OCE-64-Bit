    ...
    public class CanvasDirectedPolygon : GraphicsDirectedPolygon, IAreaShape
    {
        ...
        internal void AddAssociatedLines(GraphicsWindow window, GraphicsPage page, string lineName)
        {
            ...
            foreach (CanvasDirectedLine canvasDirectedLine in this.Perimeter)
            {
                ...
                CanvasPage.CurrentPage.AddToDirectedLineDict(lineClonedCanvasDirectedLine);

                CanvasPage.CurrentPage.LineHistoryList.Add(lineClonedCanvasDirectedLine);
            ...
            : base(window, page)
        {
            ...
            canvasDirectedPolyline.ForEach(l => { perimeterList.Add(l); l.ParentPolygon = this;  CanvasPage.CurrentPage.AddToDirectedLineDict(l); });
            ...
            : this(window, page)
        {
            ...
            foreach (GraphicsDirectedLine line in graphicsDirectedPolygon)
            {
                ...
                {
                    CanvasPage.CurrentPage.AddToDirectedLineDict(l);
                }
            }
        ...
        {            
            ...
            foreach (CanvasDirectedLine canvasDirectedLine in Perimeter)
            {
                if (deleteAssociatedLines)
                {
                    ...
                    {
                        CanvasPage.CurrentPage.LineHistoryList.Remove(canvasDirectedLine.AssociatedDirectedLine);
        ...
        internal Shape CreateInternalAreaShape()
        {
            ...
            Shape = CanvasPage.CurrentPage.DrawPolygon(coordinateArray, this.Guid);
        ...
        internal Shape CreateInternalAreaShape(string guid)
        {
            ...
            Shape = CanvasPage.CurrentPage.DrawPolygon(coordinateArray, guid);

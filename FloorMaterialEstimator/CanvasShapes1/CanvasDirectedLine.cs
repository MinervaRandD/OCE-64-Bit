...
namespace CanvasShapes
{
    ...
    public class CanvasDirectedLine: GraphicsDirectedLine, IGraphicsShape
    {
        ...
        public Shape Draw(Color lineColor, double lineWidthInPts = 3)
        {
            ...
            if (IsZeroLine)
            {
                SetBaseLineStyle(StaticGlobals.ZeroLineStyleFormula);
            }
        ...
        public void SetBaseLineStyle(AreaShapeBuildStatus buildStatus)
        {
            ...
            {
                SetBaseLineWidth(StaticGlobals.CompletedShapeLineWidthInPts);
            }
        ...
        private void SetLineGraphicsForAreaDesignState(AreaShapeBuildStatus buildStatus)
        {
            ...
            else
            {
                ...
                SetBaseLineStyle(StaticGlobals.AreaModePerimeterLineStyleFormula);

                SetBaseLineColor(StaticGlobals.AreaModePerimeterLineColor);
            }
            ...
            if (buildStatus == AreaShapeBuildStatus.Completed)
            {
                if (this.ParentPolygon is null && this.LineCompoundType == LineCompoundType.Double)
                {
                    ...
                    SetBaseLineWidth(12 * StaticGlobals.CompletedShapeLineWidthInPts);
                }
        ...
        internal new void Delete()
        {
            ...
            CanvasPage.CurrentPage.RemoveFromDirectedLineDict(this);
        ...
        {
            CanvasPage.CurrentPage.SetLineDesignStateAreaSelectionStatus(this, isSelected);
        }

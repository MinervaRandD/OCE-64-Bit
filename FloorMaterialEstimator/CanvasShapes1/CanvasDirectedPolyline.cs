...
namespace CanvasShapes
{
    ...
    public class CanvasDirectedPolyline : List<CanvasDirectedLine>
    {
        ...
        public CanvasDirectedPolyline(GraphicsWindow window, GraphicsPage page)
        {
            this.Window = window;
        ...
        private void resetAutoFillFromGuides()
        {
            ...
            CanvasPage.CurrentPage.BuildingPolyline = null;
        ...
        internal CanvasDirectedLine RemoveLastLine()
        {
            ...
            {
                CanvasPage.CurrentPage.RemoveMarkerAndGuides();
        ...
        public void SetupMarkerAndGuides()
        {
            ...
            CanvasPage.CurrentPage.SetupMarkerAndGuides(coord);
        }

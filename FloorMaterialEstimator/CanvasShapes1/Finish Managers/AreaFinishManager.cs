...
namespace CanvasShapes
{
    ...
    public class AreaFinishManager : IDisposable
    {
        ...
        private double? calculateRollWasteFactor(double netAreaInSqrInches, double perimeterInInches)
        {
            ...
            RolloutStatsCalculator rolloutStatsCalculator = new RolloutStatsCalculator(page.DrawingScaleInInches, AreaFinishBase.RollWidthInInches);
            double? wasteRatio = 0;// rolloutStatsCalculator.CalculateRolloutStats(CanvasLayoutAreas);
        ...
        {
            RolloutStatsCalculator rolloutStatsCalculator = new RolloutStatsCalculator(page.DrawingScaleInInches, finishBase.RollWidthInInches);

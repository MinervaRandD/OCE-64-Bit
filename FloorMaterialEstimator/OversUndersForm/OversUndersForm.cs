...
namespace OversUndersForm
{
   ...
   // using OversUndersLibOldVersion;
    ...
    public partial class OversUndersForm : Form
    {
        ...
        double? _largeFillPiece = null;

        double? largeFillPiece
        {
            get
            {
                return _largeFillPiece;
            }

            set
            {
                _largeFillPiece = value;

                if (_largeFillPiece.HasValue)
                {
                    this.lblLargeAreaFillPiece.Text = _largeFillPiece.Value.ToString("#,##0.0");
                }
        ...
        List<GraphicsLayoutArea> layoutAreaList = new List<GraphicsLayoutArea>();
        ...
        public void UpdatePanelDisplay()
        {
            ...
            selectedElement = baseForm.selectedAreaFinishManager;
            ...
            foreach (GraphicsLayoutArea canvasLayoutArea in selectedElement.CanvasLayoutAreas)
            {
            ...
            //virtualOverageList.AddRange(selectedElement.AreaFinishManager.VirtualOverageList);
            //virtualUndrageList.AddRange(selectedElement.AreaFinishManager.VirtualUndrageList);
       
            buildCutsPanel(cutList, drawingScaleInInches);
            ...
            setupLengthRepeats(selectedElement, cutList);

            ////setupTotals(cutList, rollWidthInInches, drawingScaleInInches);
            ...
            //areaFinishManager.CutList = this.cutList;

        }

        private void setupLengthRepeats(AreaFinishManager selectedElement, List<Cut> cutList)
        {
            string lRepeatsFormatted = FormatUtils.FormatInchesToFeetAndInches(selectedElement.RollRepeatLengthInInches);

            decimal totalRepeats = cutList.Sum(c => c.PatternRepeats);
        ...
        private void generateMaterialsLists(List<GraphicsLayoutArea> layoutAreaList)
        {
            ...
            cutList.Sort((c1, c2) => c1.CutIndex - c2.CutIndex);
        ...
        private void setupTotals(
            ...
            , double drawingScale)
        {
            int extraInchesPerCut = baseForm.selectedAreaFinishManager.ExtraInchesPerCut;
            ...
            {
                if (largeFillPiece.Value > 0)
                {
                    totalLengthInFeet += largeFillPiece.Value / drawingScale / 12.0 ;
                   // totalExtraInches += extraInchesPerCut;
                }
            ...
            int rollRepatInches = (int)areaFinishBase.RollRepeatLengthInInches;
            ...
            totlNetAreaInSquareFeet = selectedElement.AreaFinishBase.NetAreaInSqrInches /144.0;

            this.lblGrossArea.Text = totlGrossAreaInSquareFeet.ToString("#,##0.0");
            this.lblGrossAreaShortened.Text = totlGrossAreaInSquareFeet.ToString("#,##0.0");
            ...
            {
                double totlWastePercent = totlGrossAreaInSquareFeet / totlNetAreaInSquareFeet - 1.0;
            ...
            {
                this.lblTotalWastePct.Text = string.Empty;
            }

            setupLengthRepeats(selectedElement, cutList);

            areaFinishManager.GrossAreaInSqrInches = totlGrossAreaInSquareFeet * 144.0;
            areaFinishManager.NetAreaInSqrInches = totlNetAreaInSquareFeet * 144.0;
        ...
        private void buildCutsPanel(List<Cut> cutList, double drawingScaleInInInches)
        {
            ...
            foreach (Cut cut in cutList)
            {
                ...
                cutsOversUndersFormElement.Init(this, cut, drawingScaleInInInches, rollWidthInInches, extraInchesPerCut);
        ...
        {
            setupTotals(cutList, 0, rollWidthInInches, drawingScaleInFeet);
        }
        ...
        private void doUpdateTotals()
        {
            ...
            AreaFinishManager selectedAreaFinishManager = baseForm.selectedAreaFinishManager;
            ...
            largeFillPiece = rollWidthInInches * totlFillLength / 12.0;
            ...
            setupTotals(cutList, smallFillElementWidthInInches, rollWidthInInches, drawingScaleInFeet);
        ...
        private void generateMaterialsLists(
            ...
            , List<GraphicsLayoutArea> layoutAreaList)
        {
            int extraInchesPerCut = baseForm.selectedAreaFinishManager.ExtraInchesPerCut;
            ...
            // created with an overs generator that would otherwise not be part of a cut                 //
            //-------------------------------------------------------------------------------------------//
        ...
        private void btnAddVirtualOver_Click(object sender, EventArgs e)
        {
            ...
            baseForm.selectedAreaFinishManager.VirtualOverageList.Add(overage);
        ...
        private void btnDeleteSelectedOvers_Click(object sender, EventArgs e)
        {
            ...
            foreach (CanvasLayoutArea canvasLayoutArea in baseForm.selectedAreaFinishManager.CanvasLayoutAreas)
            {
        ...
        private void deleteOverFormElem(UCVirtualOversOversUndersFormElement formElem)
        {
            ...
            baseForm.selectedAreaFinishManager.VirtualOverageList.Remove(overage);
        ...
        private void btnAddVirtualUndr_Click(object sender, EventArgs e)
        {
            ...
            baseForm.selectedAreaFinishManager.VirtualUndrageList.Add(undrage);
        ...
        private void deleteUndrFormElem(UCVirtualUndrsOversUndersFormElement formElem)
        {
            ...
            baseForm.selectedAreaFinishManager.VirtualUndrageList.Remove(undrage);
        ...
        private void deleteCutsFormElem(UCvirtualCutsOversUndersFormElement formElem)
        {
            ...
            baseForm.selectedAreaFinishManager.VirtualCutsList.Remove(cut);
        ...
        {
            cutList.ForEach(c => c.Deleted = false);
        ...
        private void btnResetOvers_Click(object sender, EventArgs e)
        {
            ...
            foreach (GraphicsLayoutArea canvasLayoutArea in baseForm.selectedAreaFinishManager.CanvasLayoutAreas)
            {
                canvasLayoutArea.UpdateOverIndicesAndVisibility(ref overIndx );
            }

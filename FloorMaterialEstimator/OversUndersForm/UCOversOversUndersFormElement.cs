...
namespace OversUndersForm
{
    ...
    /// </summary>
    public partial class UCOversOversUndersFormElement : UserControl
    {
        ...
        public UCOversOversUndersFormElement()
        {
            InitializeComponent();
        }
        ...
        internal void Init(OversUndersForm oversUndersForm, Overage overage, double drawingScaleInInches, int extraInchesPerCut)
        {
            ...
            this.lblNmbr.Text = Utilities.IndexToLowerCaseString(overage.OverageIndex);

            int hghtInTotlInchs = (int)Math.Round(drawingScaleInInches * overage.EffectiveDimensions.Item1) + extraInchesPerCut;
            ...
            if (overage.ShapeHasBeenOverridden)
            {
                ...
                this.txbLnth.Text = OverLnthInch.ToString() + "' " + OverLnthInch.ToString().PadLeft(2) + "\" ";
            ...
            this.Click += UCOversOversUndersFormElement_Click;
        }

        public bool Selected { get; set; } = false;

        private void UCOversOversUndersFormElement_Click(object sender, EventArgs e)
        {
            setSelectedStatus();
        }

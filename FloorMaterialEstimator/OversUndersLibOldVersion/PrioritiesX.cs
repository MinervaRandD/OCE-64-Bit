...
namespace OversUndersLibOldVersion
{
    public class PrioritiesX
    {
        ...
        public static int[] priorityIndexPtr = new int[100];
        public static Double[] priorityWid = new double[100];
        public static Double[] priorityRem = new double[100];
        public static double wid = 0;

        public static void CreatePriorities()
        {
            double inches = SettingsX.inch * 3;
            double n = 0;
        ...
        public static double RemWid(double d)
        {
            int j = 0;
            double t = 0;

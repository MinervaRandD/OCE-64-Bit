...
namespace CombosOld
{
    public partial class UCComboElement : UserControl
    {
        ...
        public CanvasCut Cut;

        public bool Selected;

        public bool Combined;

        public UCComboElement(CanvasCut cut)
        {
            InitializeComponent();

            this.Cut = cut;

            this.lblElementNumber.Text = cut.Tag.ToString();
        ...
        public void SetSelected(bool selected)
        {
            ...
            if (selected)
            {
                ...
                VisioInterop.SetBaseFillColor(Cut.Shape, GlobalSettings.SelectedAreaColor);
                VisioInterop.SetFillOpacity(Cut.Shape, GlobalSettings.SelectedAreaOpacity);
            ...
            else
            {
                ...
                VisioInterop.SetBaseFillColor(Cut.Shape, Cut.layoutArea.UCAreaFinish.FinishColor);
                VisioInterop.SetFillOpacity(Cut.Shape, 0.0);

                VisioInterop.SetShapeText(Cut.Shape, Cut.Tag.ToString(), Color.Black, 12);
        ...
        internal void SetCombined(bool combined)
        {
            ...
            if (combined)
            {
                ...
                VisioInterop.SetBaseFillColor(Cut.Shape, Color.Orange);
                VisioInterop.SetFillOpacity(Cut.Shape, 1.0);
            }
        ...
        public int CutIndex => (int) Cut.Tag;

...
namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public class CanvasPage: GraphicsPage
    {
        ...
        public FloorMaterialEstimatorBaseForm BaseForm => CanvasManager.BaseForm;
        ...
        public void AddLayoutArea(CanvasLayoutArea canvasLayoutArea)
        {
            ...
            try
            {
                ...
                GraphicShape shape = canvasLayoutArea.Shape;

                shape.SetShapeData("[LayoutArea]", "Complex Shape", guid);
        ...
        private HashSet<CopyMarker> CopyMarkerSet = new HashSet<CopyMarker>();

        public bool AddToCopyMarkerSet(CopyMarker copyMarker)
        {
            if (CopyMarkerSet.Contains(copyMarker))
            {
                return false;
            }

            CopyMarkerSet.Add(copyMarker);

            return true;
        }

        public bool RemoveFromCopyMarkerSet(CopyMarker copyMarker)
        {
            if (!CopyMarkerSet.Contains(copyMarker))
            {
                return false;
            ...
            CopyMarkerSet.Remove(copyMarker);
        ...
        public bool SelectedLineDictContains(CanvasDirectedLine canvasDirectedLine) =>
            SelectedLineDict.ContainsKey(canvasDirectedLine.Guid);

        public bool AddToSelectedLineDict(GraphicsDirectedLine graphicsDirectedLine)
        {
            ...
            CanvasDirectedLine canvasDirectedLine = (CanvasDirectedLine) graphicsDirectedLine;

            if (SelectedLineDictContains(canvasDirectedLine))
            {
                return false;
            }
        ...
        public List<CanvasDirectedLine> LineDesignStateSelectedLines()
        {
            ...
            foreach (LineFinishManager lineFinishManager in CanvasManager.LineFinishManagerList)
            {
        ...
        public List<CanvasLayoutArea> AreaDesignStateSelectedAreas()
        {
            ...
            foreach (AreaFinishManager areaFinishManager in CanvasManager.AreaFinishManagerList)
            {
        ...
        public Dictionary<string, CanvasSeam> DisplaySeamDict = new Dictionary<string, CanvasSeam>();
        ...
        public CanvasPage(CanvasManager canvasManager, GraphicsWindow window, Visio.Document visioDocument, Visio.Page visioPage): base(window, visioDocument, visioPage)
        {
        ...
        public void UpdateAreaDesignStateAreaSelectionStatus(CanvasLayoutArea canvasLayoutArea)
        {
            if (canvasLayoutArea.AreaDesignStateEditModeSelected)
            {
                if (canvasLayoutArea.AreaFinishBase.Pattern == 0)
                {
                ...
                else
                {
                    ...
                    canvasLayoutArea.SetFillColor(canvasLayoutArea.AreaFinishBase.Color);
                    canvasLayoutArea.SetFillOpacity(canvasLayoutArea.AreaFinishBase.Opacity);
                    canvasLayoutArea.SetFillPattern(canvasLayoutArea.AreaFinishBase.Color, canvasLayoutArea.AreaFinishBase.Pattern);
        ...
        public void SetAreaDesignStateAreaSelectionStatus(CanvasLayoutArea canvasLayoutArea)
        {
            if (canvasLayoutArea.AreaDesignStateEditModeSelected)
            {
                SetAreaDesignStateAreaToDeselected(canvasLayoutArea);
            }

            else
            {
                SetAreaDesignStateAreaToSelected(canvasLayoutArea);
            }
        }

        public void SetAreaDesignStateAreaToSelected(CanvasLayoutArea canvasLayoutArea)
        {
        ...
        public void SetAreaDesignStateAreaToDeselected(CanvasLayoutArea canvasLayoutArea)
        {
            if (canvasLayoutArea == null)
            {
                return;
            ...
            canvasLayoutArea.SetFillColorAndPattern(canvasLayoutArea.AreaFinishBase.Color, canvasLayoutArea.AreaFinishBase.Pattern);
        ...
        public List<CanvasLayoutArea> SeamDesignStateSelectedAreas(string areaFinishGuid)
        {
            ...
            foreach (CanvasLayoutArea canvasLayoutArea in CanvasManager.AreaFinishManagerList[areaFinishGuid].CanvasLayoutAreas)
            {
                if (canvasLayoutArea.SeamDesignStateSelectionModeSelected)
                {
                    rtrnList.Add(canvasLayoutArea);
        ...
        public HashSet<int> UsedSeamAreaIndices(string areaFinishGuid, LayoutAreaType layoutAreaType)
        {
            ...
            foreach (CanvasLayoutArea canvasLayoutArea in CanvasManager.AreaFinishManagerList[areaFinishGuid].CanvasLayoutAreas)
            {
                ...
                if (canvasLayoutArea.SeamIndexTag.SeamAreaIndex == 0)
                {
                    continue;
                }
                ...
                rtrnSet.Add(canvasLayoutArea.SeamIndexTag.SeamAreaIndex);
            }
        ...
        public SortedList<int, double> SeamModeAreaData(string guid)
        {
            ...
            AreaFinishManager areaFinishManager = CanvasManager.AreaFinishManagerList[guid];
            ...
            foreach (CanvasLayoutArea canvasLayoutArea in areaFinishManager.CanvasLayoutAreas)
            {
                ...
                // else if (canvasLayoutArea.SeamDesignStateSelectionModeSelected && canvasLayoutArea.IsSeamed())
                    ...
                    (canvasLayoutArea.SeamDesignStateSelectionModeSelected || canvasLayoutArea.AreaFinishBase.SeamAreaLocked)
                    && canvasLayoutArea.IsAutomaticSeamed())
                {
                    if (canvasLayoutArea.SeamIndexTag is null)
                    {
                        continue;
                    ...
                    if (canvasLayoutArea.LayoutAreaType == LayoutAreaType.Normal)
                    {
                        ...
                        {
                           rtrnList.Add(canvasLayoutArea.SeamIndexTag.SeamAreaIndex, canvasLayoutArea.NetAreaInSqrInches());
                        }
                    }
                }
            }
        ...
        public SortedList<int, double> SeamModeSeamData(string guid)
        {
            ...
            foreach (CanvasLayoutArea canvasLayoutArea in areaFinishManager.CanvasLayoutAreas)
            {
                if (canvasLayoutArea.SeamDesignStateSelectionModeSelected)
                {
                    ...
                    if (canvasLayoutArea.SeamAreaIndex == 0) // this occurs when the only seams are manual seams
                    {
                        continue;
                    }


                    if (canvasLayoutArea.LayoutAreaType != LayoutAreaType.ColorOnly && canvasLayoutArea.LayoutAreaType != LayoutAreaType.OversGenerator)
                    {
        ...
        public void UpdateSeamTotals()
        {
            ...
            foreach (SeamFinishBase seamFinishBase in CanvasManager.FinishSeamBaseList)
            {
        ...
        public void UpdateSeamDesignStateAreaSelectionStatus(CanvasLayoutArea canvasLayoutArea, string selectedAreaFinishGuid)
        {
            ...
            FloorMaterialEstimator.DebugSupportRoutines.CheckForNullInPageShapeDict(this, 10);
            ...
            if (canvasLayoutArea.SeamDesignStateSelectionModeSelected)
            {
                ...
                if (!(canvasLayoutArea.SeamIndexTag is null))
                {
                    canvasLayoutArea.AreaFinishManager.SeamDesignStateLayer.RemoveShapeFromLayer(canvasLayoutArea.SeamIndexTag.Shape, 1);
            ...
            else
            {
                ...
                else
                {
                    ...
                    // canvasLayoutArea.AreaFinishManager.AreaFinishLayers.SeamDesignStateLayer.AddShape(canvasLayoutArea.SeamIndexTag.Shape, 1);

                    if (canvasLayoutArea.LayoutAreaType == LayoutAreaType.Remnant)
                    {
                        canvasLayoutArea.AreaFinishManager.RemnantSeamDesignStateLayer.AddShape(canvasLayoutArea.SeamIndexTag.Shape, 1);
                    }
                }
            }

            FloorMaterialEstimator.DebugSupportRoutines.CheckForNullInPageShapeDict(this, 20);


            // The following commented out -- client did not want any line changes when selected.

            //foreach (CanvasLayoutArea layoutArea in this.LayoutAreas)
            //{
            //    layoutArea.SetLineGraphics(CanvasManager.DesignState, layoutArea.SeamDesignStateSelectionModeSelected && layoutArea.AreaFinishManager.Selected, AreaShapeBuildStatus.Completed);
            //}


            FloorMaterialEstimator.DebugSupportRoutines.CheckForNullInPageShapeDict(this, 30);
        }
        ...
        public void UpdateSelectedAreaColors(int colorIndex)
        {
            ...
            if (CanvasManager.layoutAreaForSubdivisionDict.ContainsKey(FinishGlobals.SelectedAreaFinish.Guid))
            {
                CanvasLayoutArea layoutAreaForSubdivision = CanvasManager.layoutAreaForSubdivisionDict[FinishGlobals.SelectedAreaFinish.Guid];
        ...
        public void ProcessShowUnseamedAreas(bool show)
        {
            ...
            if (show)
            {
                ...
                {
                    if (canvasLayoutArea.IsAutomaticSeamed())
                    {
                        continue;
                    }
        ...
        public void ProcessShowZeroAreas(bool show)
        {
            ...
            if (show)
            {
                foreach (CanvasLayoutArea canvasLayoutArea in LayoutAreas)
                {
                    if (canvasLayoutArea.LayoutAreaType != LayoutAreaType.ColorOnly)
                    {
                        continue;
                    }
            ...
            , LayoutAreaType layoutAreaType = LayoutAreaType.Unknown)
        {
            ...
            List<CanvasLayoutArea> list = new List<CanvasLayoutArea>();
         ...
         , LayoutAreaType layoutAreaType = LayoutAreaType.Unknown)
        {
            ...
            AreaFinishBase selectedAreaFinishBase = BaseForm.selectedAreaFinish.AreaFinishBase;

            //SortedList<double, CanvasLayoutArea> selectedCanvasLayoutAreas = null;
            //SortedList<double, CanvasLayoutArea> nonSelectedCanvasLayoutAreas = null;

            CanvasLayoutArea selectedCanvasLayoutArea = null;
            CanvasLayoutArea nonSelectedCanvasLayoutArea = null;

            double selectedLayoutAreaArea = 0;
            double nonSelectedLayoutAreaArea = 0;

            foreach (Visio.Shape visioShape in selection)
            {
                string guid = visioShape.Data3;

                CanvasLayoutArea layoutArea = this.GetCanvasLayoutAreaByGuid(guid);
                ...
                AreaFinishBase areaFinishBase = layoutArea.AreaFinishBase;

                if (areaFinishBase == selectedAreaFinishBase)
                {
                    if (selectedCanvasLayoutArea == null)
                    {
                        selectedCanvasLayoutArea = layoutArea;
                        selectedLayoutAreaArea = VisioInterop.GetShapeArea(selectedCanvasLayoutArea.Shape);
                    }

                    else
                    {
                        if (selectedCanvasLayoutArea.CreatedDateTime < layoutArea.CreatedDateTime)
                        {
                            selectedCanvasLayoutArea = layoutArea;
                            selectedLayoutAreaArea = VisioInterop.GetShapeArea(selectedCanvasLayoutArea.Shape);
                        }

                        else if (selectedCanvasLayoutArea.CreatedDateTime == layoutArea.CreatedDateTime)
                        {
                            // This should never happen. Totally defensive;

                            double layoutAreaArea = VisioInterop.GetShapeArea(layoutArea.Shape);
                            
                            if (layoutAreaArea < selectedLayoutAreaArea)
                            {
                                selectedCanvasLayoutArea = layoutArea;
                                selectedLayoutAreaArea = VisioInterop.GetShapeArea(selectedCanvasLayoutArea.Shape);
                            }
                ...
                {
                    if (nonSelectedCanvasLayoutArea == null)
                    {
                        nonSelectedCanvasLayoutArea = layoutArea;
                        nonSelectedLayoutAreaArea = VisioInterop.GetShapeArea(nonSelectedCanvasLayoutArea.Shape);
                    }

                    else
                    {
                        if (nonSelectedCanvasLayoutArea.CreatedDateTime < layoutArea.CreatedDateTime)
                        {
                            nonSelectedCanvasLayoutArea = layoutArea;
                            nonSelectedLayoutAreaArea = VisioInterop.GetShapeArea(nonSelectedCanvasLayoutArea.Shape);
                        }

                        else if (nonSelectedCanvasLayoutArea.CreatedDateTime == layoutArea.CreatedDateTime)
                        {
                            // This should never happen. Totally defensive;
            ...
            if (selectedCanvasLayoutArea != null)
            {
                return selectedCanvasLayoutArea;
            }

            if (nonSelectedCanvasLayoutArea != null)
            {
                return nonSelectedCanvasLayoutArea;
            }
        ...
        internal CanvasLayoutArea GetContainingLayoutArea(Coordinate coord)
        {
            ...
            foreach (Visio.Shape visioShape in selection)
            {
                ...
                if (BaseForm.selectedAreaFinish.AreaFinishBase !=  layoutArea.AreaFinishBase)
                {
                    continue;
                }
            ...
            , bool ignoreBorderAreas = false)
        {
            ...
            try
            {
                Debug.Assert(CanvasManager.DesignState == DesignState.Seam); // This should only be used in seam design mode as currently designed.
        ...
        public void UpdateLineDesignStateLineSelectionStatus(CanvasDirectedLine canvasDirectedLine)
        {
            if (canvasDirectedLine.LineDesignStateEditModeSelected)
            {
                SetLineDesignStateLineToDeSelected(canvasDirectedLine);
            }

            else
            {
                SetLineDesignStateLineToSelected(canvasDirectedLine);
            }
        }

        public void SetLineDesignStateLineToSelected(CanvasDirectedLine canvasDirectedLine)
        {
            ...
            AddToSelectedLineDict(canvasDirectedLine);
        }


        public void SetLineDesignStateLineToDeSelected(CanvasDirectedLine canvasDirectedLine)
        {
        ...
        public override double DrawingScaleInInches
        {
            ...
            set
            {
                ...
                SystemState.BtnSetCustomScale.Image = SystemGlobals.CustomScaleLineColoredImage;
        ...
        public bool ScaleHasBeenSet
        {
            ...
            set
            {
                ...
                BaseForm.ScaleStateChangeHandler(SystemState.ScaleHasBeenSet);

                if (value == true)
                {
                    BaseForm.tlsDrawoutLength.Text = string.Empty;
                }
        ...
        internal void SetDefaultScale(double drawingScaleInInches)
        {
            ...
            SystemState.BtnSetCustomScale.Image = SystemGlobals.CustomScaleLineUncoloredImage;
        ...
        internal bool UnseamedAreasExist()
        {
            foreach (CanvasLayoutArea layoutArea in LayoutAreas)
            {
                if (layoutArea.AreaFinishManager.MaterialsType != MaterialsType.Rolls)
                {
                    continue;
                }

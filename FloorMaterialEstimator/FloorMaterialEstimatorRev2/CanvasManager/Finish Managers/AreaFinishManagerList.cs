...
namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public class AreaFinishManagerList : List<AreaFinishManager>, IDisposable
    {
        ...
        private void AreaFinishBaseList_ItemSelected(int itemIndex)
        {
            ...
            {
                AreaFinishManager areaFinishManager = this[indx];

                //if (indx== itemIndex)
                //{
                //    areaFinishManager.SetSeamDesignStateLockLayerVisiblity(SystemState.RbnShowAllLocks.Checked);
                //}

                //else
                //{
                //    areaFinishManager.SetSeamDesignStateLockLayerVisiblity(false);
                //}
            }
        ...
        public static implicit operator CanvasManagerLib.FinishManager.AreaFinishManagerList(AreaFinishManagerList areaFinishManagerList)
        {
            return new CanvasManagerLib.FinishManager.AreaFinishManagerList(
                areaFinishManagerList.window
                , areaFinishManagerList.page
                , areaFinishManagerList.areaFinishBaseList);
        }

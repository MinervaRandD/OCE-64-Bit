...
//    using FloorMateralEstimator.CanvasManager;
    ...
    public class CanvasDirectedPolyline : List<CanvasDirectedLine>
    {
        ...
        internal bool ValidateNoIntersection(double x2, double y2)
        {
            if (this.Count <= 0)
            {
                return true;
            ...
            return ValidateNoIntersection(x1, y1, x2, y2);
        }

        //// This allows intersection at endpoints only.

        //internal bool ValidateNoIntersection1(double x2, double y2)
        //{
        //    if (this.Count <= 0)
        //    {
        //        return true;
        ...
        //    return ValidateNoIntersection1(x1, y1, x2, y2);
        //}

        internal bool ValidateNoIntersection(double x1, double y1, double x2, double y2)
        {
            if (this.Count <= 0)
            {
                return true;
            ...
            if (directedLine.IntersectsOrOverlaps(this[Count - 1]))
            {
                return false;
            }
        ...
        //internal bool ValidateNoIntersection1(double x1, double y1, double x2, double y2)
        //{
        //    if (this.Count <= 0)
        //    {
        //        return true;
        ...
        //    for (int i = 0; i < this.Count - 1; i++)
        //    {
        //        if (directedLine.IntersectsInterior(this[i]))
        //        {
        //            return false;
        //        }
        //    }
        ...
        { 
            ...
            //VisioInterop.AddGuide(currCoord.X, currCoord.Y);

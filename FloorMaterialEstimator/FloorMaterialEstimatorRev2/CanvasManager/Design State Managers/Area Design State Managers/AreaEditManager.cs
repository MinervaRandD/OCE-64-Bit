    ...
    public partial class CanvasManager
    {
        ...
        private void processCopyAndPasteAction(double x, double y)
        {
            ...
            if (canvasLayoutArea == CopySelectedLayoutArea)
            {
                ...
                {
                    Page.RemoveFromPageShapeDict(canvasLayoutArea.CopyMarker.Shape);
            ...
            if (CopySelectedLayoutArea.CopyMarker is null)
            {
                // Not sure how this error occurs.

                MessageBox.Show("No copy marker found for selected area.");
                return;
            }
            ...
            else
            {
                ...
                {
                    externPerimeterLine.LineFinishManager.SeamDesignStateLayer.AddShape(externPerimeterLine, 1);
                }
                ...
                pasteLayoutArea.ExternalArea.Shape.SetLineOpacity(1);
        ...
        public void ProcessEditAreaModeActionChangeShapeToFinish(CanvasLayoutArea canvasLayoutArea, AreaFinishManager areaFinishManager)
        {
            ...
            FinishManagerGlobals.AreaFinishManagerList.MoveCanvasLayoutAreaToFinishType(canvasLayoutArea, areaFinishManager);
        ...
        public void ProcessEditAreaModeActionDeleteShape(CanvasLayoutArea canvasLayoutArea, bool IsTopLevel = true)
        {
            ...
            try
            {
                ...
                areaFinishManager.UpdateFinishStats(true);

                BaseForm.OversUndersFormUpdate(areaFinishManager, false);
        ...
        public void ProcessEditAreaApply(EditAreaMode editAreaMode)
        {
            ...
            {
                ManagedMessageBox.Show("Edit mode not implemented");
            }

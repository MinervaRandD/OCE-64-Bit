namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public partial class CanvasManager
    {
        ...
        public void ProcessAreaDesignStateClick(int button, int keyButtonState, double x, double y, ref bool cancelDefault)
        {
            ...
            //Point point1 =SystemGlobals.GetCursorPosition();

            processAreaDesignStateLayoutModeClick(button, keyButtonState, x, y, ref cancelDefault);

           // Point point2 = SystemGlobals.GetCursorPosition();
        ...
        private void SnapToLeftGuideLine()
        {
            ...
            if (FieldGuideController.SnapToLeftFieldGuide(MouseX, MouseY, 0, SystemGlobals.GetCursorPosition(), out p))
            {
        ...
        private void SnapToRghtGuideLine()
        {
            ...
            if (FieldGuideController.SnapToRghtFieldGuide(MouseX, MouseY, 0, SystemGlobals.GetCursorPosition(), out p))
            {
                SystemGlobals.SetCursorPosition(p);
            }
        }
        ...
        private void completeAreaDesignStatePolylineDraw(CanvasDirectedPolyline BuildingPolyline, int finishIndex = 0)
        {
            ...
            if (finishIndex > 0)
            {
                ...
                areaFinishManager = FinishManagerGlobals.AreaFinishManagerList[finishIndex - 1];
            }

            AddAreaPolylineToCanvas(BuildingPolyline, areaFinishManager, ucAreaFinish, null, null, !(SystemState.CurrentLayoutType == LayoutAreaType.ColorOnly || SystemState.CurrentLayoutType == LayoutAreaType.OversGenerator));
            ...
            FinishManagerGlobals.SelectedLineFinishManager.SetLineState(DesignState.Area, SeamMode, true);
            ...
            , bool createAssociatedLineModeLines = true)
        {
            ...
            AreaFinishManager selectedAreaFinish = FinishManagerGlobals.AreaFinishManagerList.SelectedAreaFinishManager;
            ...
            , bool createAssociatedLineModeLines)
        {
            ...
            foreach (CanvasDirectedLine canvasDirectedLine in canvasDirectedPolyline)
            {
                ...
                if (createAssociatedLineModeLines)
                {
                    ...
                    GraphicShape shape = lineClonedCanvasDirectedLine.Draw();
                    ...
                    lineFinishManager.LineDesignStateAssociatedLineLayer.AddShape(lineClonedCanvasDirectedLine, 1);
            ...
            foreach (CanvasDirectedLine canvasDirectedLine in canvasLayoutAreaLineList)
            {
                ...
                GraphicShape shape = canvasDirectedLine.Draw();
                ...
                if (SystemState.CurrentLayoutType == LayoutAreaType.ColorOnly)
                {
        ...
        private void addTakeoutAreaToCanvas(CanvasLayoutArea canvasLayoutArea, CanvasDirectedPolygon canvasDirectedPolygon, UCAreaFinishPaletteElement ucAreaFinish)
        {
            ...
            if (FinishManagerGlobals.SelectedAreaFinishManager.MaterialsType == FinishesLib.MaterialsType.Rolls)
            {
 ...
 
        {
            ...
            EmbeddedLayoutGenerator embeddedLayoutGenerator = new EmbeddedLayoutGenerator(externalArea, layoutAreaList, areaFinishManager.AreaFinishLayers);
            ...
            {
                CanvasLayoutArea canvasLayoutArea = new CanvasLayoutArea(this, layoutArea, areaFinishManager, finishLibElements,  ucAreaFinish);
                ...
                if (canvasLayoutArea.InternalAreas.Count > 0)
                {
                    List<GraphicShape> internalAreaShapes = canvasLayoutArea.InternalAreas.ConvertAll(i => i.Shape);
            ...
            )
        {
            ...
            if (SystemState.CurrentLayoutType == LayoutAreaType.OversGenerator)
            {
                double oversGeneratorOversWidthInInches = SystemState.OversGeneratorWidthInInches;
        ...
        public void AddAreaCanvasLayoutAreaToCanvas(CanvasLayoutArea canvasLayoutArea, AreaFinishManager areaFinishManager)
        {
            ...
            if (canvasLayoutArea.LayoutAreaType == LayoutAreaType.ColorOnly)
            {
                ...
                areaFinishManager.AddNormalLayoutAreaAreaStateOnly(canvasLayoutArea, true, false);
            }

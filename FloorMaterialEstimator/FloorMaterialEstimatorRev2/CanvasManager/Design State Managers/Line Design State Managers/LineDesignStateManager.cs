namespace FloorMaterialEstimator.CanvasManager
{
    ...
    public partial class CanvasManager
    {
        ...
        {
            if (SelectedLineFinishManager.Filtered)
            {
                MessageBoxAdv.Show(
                    "Selected line type is filtered. Clear filter to continue.", "Selected Line Type Is Filtered", MessageBoxAdv.Buttons.OK, MessageBoxAdv.Icon.Exclamation);
                return;
            }
        ...
        {
            if (BaseForm.FormLineFinishes != null)
            {
                if (BaseForm.FormLineFinishes.EditingWallHeight)
                {
                    return;
                }
            }

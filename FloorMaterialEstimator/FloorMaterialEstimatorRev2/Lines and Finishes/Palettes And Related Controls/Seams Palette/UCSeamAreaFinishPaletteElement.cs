       ...
       // AreaFinishBaseList areaFinishBaseList => canvasManager.BaseForm.AreaFinishBaseList;
        ...
        private void setupTallyDisplay(bool scaleHasBeenSet)
        {
            this.lblRollSqrYrds.Text =
                '(' + this.effectiveWidth.ToString("0.00") + ")  "
            ...
            if (scaleHasBeenSet)
            {
                ...
                {
                    //double grossAreaInSqrFeet = AreaFinishBase.NetAreaInSqrInches / 144.0; // Use net to start
                    ...
                    lblAreaValue.Text = netAreaInSqrFeet.ToString("#,##0.0") + " s.f.";
                ...
                else
                {
                    ...
                    lblAreaValue.Text = netAreaInSqrYds.ToString("#,##0.0") + " s.y.";
        ...
        internal void SetSeam(SeamFinishBase finishSeamBase)
        {
            ...
            this.FinishSeamBase = finishSeamBase;

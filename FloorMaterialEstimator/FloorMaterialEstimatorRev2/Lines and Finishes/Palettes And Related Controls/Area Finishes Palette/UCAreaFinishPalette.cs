...
namespace FloorMaterialEstimator.Finish_Controls
{
    ...
    public partial class UCAreaFinishPalette : UserControl, IEnumerable<UCAreaFinishPaletteElement>
    {
        ...
        public AreaFinishBaseList AreaFinishBaseList => StaticGlobals.AreaFinishBaseList;
        ...
        public void Select(int selectedItemIndex)
        {
           ...
           // ucFlowLayoutPanel.AutoScrollPosition = new Point(ucAreaFinish.Left, ucAreaFinish.Top);
            ...
            {
                StaticGlobals.SetupAllSeamStateSeamLayersForSelectedArea();
            }
        }
        ...
        internal void UpdateZeroLineDisplay(bool zeroLineSelected)
        {
            if (!zeroLineSelected)
            {

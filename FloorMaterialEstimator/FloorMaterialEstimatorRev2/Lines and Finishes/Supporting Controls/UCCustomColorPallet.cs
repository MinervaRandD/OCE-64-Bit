...
namespace FloorMaterialEstimator.Finish_Controls
{
    ...
    public partial class UCCustomColorPallet : UserControl
    {
        private argb[] colorPallet;
        ...
        public UCCustomColorPallet()
        {
            InitializeComponent();
        }

        public void Init(argb[] colorPallet)
        {
        ...
        private void BtnSystemColors_Click(object sender, EventArgs e)
        {
            ...
            ColorDialogExtended colorDialog = new ColorDialogExtended(location.X + 256, location.Y);

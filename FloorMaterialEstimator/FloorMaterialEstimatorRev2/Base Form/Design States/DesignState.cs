...
namespace FloorMaterialEstimator
{
    ...
    public partial class FloorMaterialEstimatorBaseForm
    {
                    ...
                    case DesignState.Line:
                        {
                            ...
                            CanvasManager.ClearAreaModeSelectedAreaSelections();

                            CanvasManager.ShowSeamsInLineModeInitialized = false;
                    ...
                    case DesignState.Seam:
                        {
                            ...
                            if (SystemState.InitializeSeamStateForExistingProject == true)
                            {
                                //initializeSeamStateForExistingProject();
        ...
        //private void initializeSeamStateForExistingProject()
        //{
        //    foreach (AreaFinishManager areaFinishManager in AreaFinishManagerList)
        //    {
        //        areaFinishManager.initializeSeamStateForExistingProject();
        //    }
        //}
        ...
        public void SetupLineState()
        {
            ...
            CurrentPage.AreaLegendLayer.SetLayerVisibility(SystemGlobals.ShowAreaLegendInLineMode);
            CurrentPage.LineLegendLayer.SetLayerVisibility(SystemGlobals.ShowLineLegendInLineMode);
          ...
          //  CurrentPage.LockIconLayer.SetLayerVisibility(false);

            CanvasManager.CounterController.ResetAllCounterLayerVisibility();

            AreaFinishManagerList.SetupAllSeamLayers();

            this.btnEditAreas.Enabled = true;
            this.btnEditSeams.Enabled = true;
            this.btnEditLines.Enabled = true;

            this.pbxAreaPaletteState.Visible = false;
        }
        ...
        public void SetupAreaState()
        {
            ...
            CurrentPage.AreaLegendLayer.SetLayerVisibility(SystemGlobals.ShowAreaLegendInAreaMode);
            CurrentPage.LineLegendLayer.SetLayerVisibility(SystemGlobals.ShowLineLegendInAreaMode);
            ...
            this.pbxAreaPaletteState.Visible = true;
        }
        ...
        private void SetupSeamState()
        {
            ...
            this.btnEditAreas.Enabled = false;
            this.btnEditSeams.Enabled = false;
            this.btnEditLines.Enabled = false;


            this.pbxAreaPaletteState.Visible = false;

            seamPalette.UpdateSeamAreaPalette();
        }

...
namespace FloorMaterialEstimator
{
    ...
    public partial class DebugForm : Form, ICursorManagementForm
    {
        ...
        private void setupBaseVisioShapes()
        {
            ...
            this.dgvBaseVisioShapes.Columns.Add("Data 4", "Locked");
            ...
            this.dgvBaseVisioShapes.Columns[3].Width = 50;
        ...
        private void setupCanvasShapes()
        {
            ...
            this.dgvCanvasShapes.Columns.Add("Data 4", "Locked");
            ...
            this.dgvCanvasShapes.Columns[2].Width = 50;
        ...
        private void setupDirectedLines()
        {
            ...
            this.dgvDirectedLines.Columns.Add("Width", "Width");
            this.dgvDirectedLines.Columns.Add("Color", "Color");
            this.dgvDirectedLines.Columns.Add("Transparency", "Transparency");
            this.dgvDirectedLines.Columns.Add("Visible", "Visible");
            ...
            this.dgvDirectedLines.Columns[5].Width = 96;
            this.dgvDirectedLines.Columns[6].Width = 128;
            this.dgvDirectedLines.Columns[7].Width = 128;
            this.dgvDirectedLines.Columns[8].Width = 96;
        ...
        private void populateBaseVisioShapes()
        {
            ...
            foreach (Visio.Shape visioShape in page.VisioPage.Shapes)
            {
                ...
                string data4 = VisioInterop.IsLocked(visioShape) ? "Yes" : "No";

                dgvBaseVisioShapes.Rows.Add(new object[] { data1, data2, data3, data4 });
        ...
        private void populateCanvasShapes()
        {
            ...
            foreach (IGraphicsShape iShape in page.PageShapeDictValues)
            {
                ...
                string data4 = shape.IsLocked ? "Yes" : "No";
                ...
                dgvCanvasShapes.Rows.Add(new object[] { data1, data2, data3, data4 });
            }
        ...
        private void populateDirectedLines()
        {
            ...
            foreach (CanvasDirectedLine directedLine in currentPage.DirectedLines)
            {
                ...
                string width = VisioInterop.GetLineWidth(directedLine.Shape) + '(' + VisioInterop.GetShapeWidth(directedLine.Shape).ToString("0.00") + ')';

                string color = VisioInterop.GetBaseLineColor(directedLine.Shape).Substring(14);
                color = color.Substring(0, color.Length - 1);

                string transparency = VisioInterop.GetBaseLineTransparecy(directedLine.Shape);

                double? dblVisisble = VisioInterop.GetShapeLineVisibility(directedLine.Shape);

                string visible = dblVisisble.HasValue ? dblVisisble.Value.ToString() : string.Empty;
        ...
        private void populateGraphicsLayers()
        {
            ...
            foreach (GraphicsLayer graphicsLayer in currentPage.GraphicsLayers)
            {
                ...
                string isLocked = graphicsLayer.IsLocked ? "Yes" : "No";
        ...
        private void populateVisioLayers()
        {
            ...
            foreach (Visio.Layer layer in page.VisioPage.Layers)
            {
                ...
                string isLocked = VisioInterop.IsLocked(layer) ? "Yes" : "No";
        ...
        private void populateGraphicsShapes()
        {
            ...
            foreach (IGraphicsShape iShape in this.page.PageShapeDictValues)
            {
                ...
                shapeList.Add((GraphicShape) iShape);
            }
        ...
        private TreeNode generateTreeNode(GraphicsLayer layer)
        {
            ...
            try
            {
                ...
                foreach (IGraphicsShape iShape in layer.ShapeDict.Values)
                {
                    ...
                    treeNode.Nodes.Add(generateTreeNode(shape));
                }
        ...
        private TreeNode generateTreeNode(GraphicShape shape)
        {
        ...
        private void setupGraphicsLayers()
        {
            ...
            this.dgvGraphicsLayers.Columns.Add("Locked", "Locked");
            ...
            this.dgvGraphicsLayers.Columns[5].DefaultCellStyle.Font = new System.Drawing.Font("Courier New", 10F, FontStyle.Regular);
            this.dgvGraphicsLayers.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.dgvGraphicsLayers.Columns[5].Width = 55;
        ...
        private void setupVisioLayers()
        {
            ...
            this.dgvVisioLayers.Columns.Add("Locked", "Locked");
            ...
            this.dgvVisioLayers.Columns[4].DefaultCellStyle.Font = new System.Drawing.Font("Courier New", 10F, FontStyle.Regular);
            this.dgvVisioLayers.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            ...
            this.dgvVisioLayers.Columns[4].Width = 55;

...
namespace FloorMaterialEstimator
{
    ...
    public partial class FloorMaterialEstimatorBaseForm
    {
        ...
        public void BtnFilterAreasClick() => BtnFilterAreas_Click(null, null);
        ...
        public void BtnFilterLinesClick() => this.BtnFilterLines_Click(null, null);
        ...
        private void BtnSummaryReport_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SummaryReportForm.Init(
                    AreaFinishBaseList
                    , LineFinishBaseList
                    , SeamFinishBaseList
                    , counterList
                    , CurrentPage.ScaleHasBeenSet
                    , OversUndersForm.UpdatePanelDisplayForSelectedElementNumber);
        ...
        private void BtnShowAreas_Click(object sender, EventArgs e)
        {
            ...
            {
                this.btnShowAreas.Image = SystemGlobals.HideAreaImage;
            ...
            {
                this.btnShowAreas.Image = SystemGlobals.ShowAreaImage;
        ...
        private void BtnShowDrawing_Click(object sender, EventArgs e)
        {
            ...
            {
                this.btnShowDrawing.Image = SystemGlobals.HideDrawingImage;
            ...
            {
                this.btnShowDrawing.Image = SystemGlobals.ShowDrawingImage;
        ...
        private void btnRedoSeamsAndCuts_Click(object sender, EventArgs e)
        {
            ...
            btnRedoSeamsAndCuts.Image = SystemGlobals.RedoSeamsOffImage;
        }
        ...
        public void OversUndersFormUpdate(bool warnOnMaterialType = true)
        {
            ...
            OversUndersForm.UpdatePanelDisplay(FinishManagerGlobals.SelectedAreaFinishManager, OversUndersForm.RbnUpdateFillsAutomatically.Checked);
        }

        public void OversUndersFormUpdate(AreaFinishManager areaFinishManager, bool warnOnMaterialType = true)
        {
            if (warnOnMaterialType)
            {
                if (selectedAreaFinish.MaterialsType != MaterialsType.Rolls)
            ...
            OversUndersForm.UpdatePanelDisplay(areaFinishManager, OversUndersForm.RbnUpdateFillsAutomatically.Checked);
        }
        ...
        public void ExpandCanvas()
        {
            ...
            btnFullScreen.Image = SystemGlobals.ContractCanvasImage;
        ...
        public void ContractCanvas()
        {
            ...
            btnFullScreen.Image = SystemGlobals.ExpandCanvasImage;
        ...
        private GlobalSettingsController globalSettingsController = null;
        ...
        private void BtnGeneralSettings_Click(object sender, EventArgs e)
        {
            ...
            {
                globalSettingsController = new GlobalSettingsController(CanvasManager.Window, CanvasManager.Page);
            }
            

            globalSettingsController.SetGlobalSettings();

            SetShowAreaOutlineInLineModeChanged();
        ...
        private void SetShowAreaOutlineInLineModeChanged()
        {
            ...
            {
                lineFinishManager.LineDesignStateAssociatedLineLayer.SetLayerVisibility(GlobalSettings.ShowAreaOutlineInLineMode);
            }
        }
        ...
        private bool canvasContainsAreasOrLines()
        {
            if (currentPage.LayoutAreaDict != null)
            {
                if (currentPage.LayoutAreaDict.Count > 0)
                {
                    return true;
                }
            }

            if (currentPage.DirectedLineDict != null)
            {
                if (currentPage.DirectedLineDict.Count > 0)
                {
                    return true;
                }
            }
        ...
        private void BtnLoadCustomPaletteDefinitions_Click(object sender, EventArgs e)
        {
            if (canvasContainsAreasOrLines())
            {
                MessageBox.Show("Cannot load custom palette definitions because the canvas currently has areas or lines defined.");
                return;
            }
        ...
        private void BtnLoadBasePaletteDefinitions_Click(object sender, EventArgs e)
        {
            if (canvasContainsAreasOrLines())
            {
                MessageBox.Show("Cannot load baseline palette definitions because the canvas currently has areas or lines defined.");
                return;
            }

            loadBaseFinishPalettes();
        }
    }

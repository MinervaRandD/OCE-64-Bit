...
namespace FloorMaterialEstimator.OversUndersForm
{
    ...
    /// </summary>
    public partial class UCVirtualUndrsOversUndersFormElement : UserControl
    {
        public VirtualUndrage Undrage { get; set; }
        ...
        /// </summary>
        public UCVirtualUndrsOversUndersFormElement()
        {
            InitializeComponent();
        }
        ...
        internal void Init(OversUndersForm oversUndersForm, uint index, VirtualUndrage undrage, double drawingScaleInInches = 1.0)
        {
            ...
            this.lblNmbr.Text = Utilities.IndexToUpperCaseString(index+1);

            int hghtInTotlInchs = (int)Math.Round(drawingScaleInInches * undrage.EffectiveDimensions.Item1);
            ...
            this.Click += UCVirtualUndrsOversUndersFormElement_Click;
        }

        public bool Selected { get; set; } = false;

        private void UCVirtualUndrsOversUndersFormElement_Click(object sender, EventArgs e)
        {
            setSelectedStatus();
        }

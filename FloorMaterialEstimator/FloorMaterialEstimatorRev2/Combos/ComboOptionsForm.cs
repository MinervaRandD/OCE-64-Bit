...
namespace FloorMaterialEstimator
{
    ...
    public partial class ComboOptionsForm : Form
    {
        ...
        public ComboOptionsForm(FloorMaterialEstimatorBaseForm baseForm, List<ComboPartitionSolution> solutionList, double drawingScaleInFeet)
        {
            InitializeComponent();

...
namespace SettingsLib
{
    ...
    public partial class GlobalSettingsForm : Form, ICursorManagementForm
    {
        ...
        //{
        //    toolTipTextEditForm.Location = Cursor.Position;

        //    toolTipTextEditForm.Show();

        //    toolTipTextEditForm.BringToFront();
        //}
        ...
        {
            Utilities.SetTextFormatForValidDouble(this.txbDefaultWidth);
        }

        private void TxbDefaultHeight_TextChanged(object sender, EventArgs e)
        {
            Utilities.SetTextFormatForValidDouble(this.txbDefaultHeight);
        }
        ...
        {
            Utilities.SetTextFormatForValidDouble((TextBox)sender);
        }
        ...
        {
            Utilities.SetTextFormatForValidDouble(this.txbSnapToAxisResolutionInDegrees);
        }

        private void TxbSnapDistance_TextChanged(object sender, EventArgs e)
        {
            Utilities.SetTextFormatForValidDouble(this.txbSnapDistance);
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                ManagedMessageBox.Show("The minimum overage width is invalid");
                return;
            }
            ...
            {
                ManagedMessageBox.Show("The minimum overage length is invalid");
                return;
            }
            ...
            {
                ManagedMessageBox.Show("The minimum underage width is invalid");
                return;
            }
            ...
            {
                ManagedMessageBox.Show("The minimum underage length is invalid");
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbSmallCircleRadius, "the small counter circle radius"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbMediumCircleRadius, "the medium counter circle radius"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbLargeCircleRadius, "the large counter circle radius"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbSmallFontSizeInPts, "the small counter font"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbMediumFontSizeInPts, "the medium counter font"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbLargeFontSizeInPts, "the large counter font"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbDefaultDrawingScaleInInches, "the default drawing scale in inches"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbDefaultWidth, "the default drawing width in inches"))
            {
                return;
            }

            if (!Utilities.CheckTextBoxValidDouble(this.txbDefaultHeight, "the default drawing height in inches"))
            {
                return;
            }
        ...
        {
            Utilities.SetTextFormatForValidDouble(this.txbDefaultDrawingScaleInInches);
        }

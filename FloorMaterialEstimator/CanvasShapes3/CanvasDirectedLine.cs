...
namespace CanvasShapes
{
    ...
    public class CanvasDirectedLine: GraphicsDirectedLine, IGraphicsShape
    {
        ...
        public CanvasDirectedLine(
            ...
            : base(canvasWindow, canvasPage, line, line.LineRole, isDoubleLine)
        {
            ...
            , CanvasDirectedLine line)
        {
            ...
            ucLine = linePalette[line.LineFinishManager.Guid];

            LineFinishManager = FinishManagerGlobals.LineFinishManagerList[line.LineFinishManager.Guid];
        ...
        public Shape Draw(Color lineColor, double lineWidthInPts = 3)
        {
            Shape shape = base.Draw(lineColor, lineWidthInPts);
        ...
        {
            return new CanvasDirectedLine(this.canvasWindow, canvasPage, this.LineFinishManager, base.ExtendStart(extensionLength), SystemState.DesignState);
        }

        internal new  CanvasDirectedLine ExtendEnd(double extensionLength)
        {
            return new CanvasDirectedLine(this.canvasWindow, this.canvasPage, this.LineFinishManager, base.ExtendEnd(extensionLength), SystemState.DesignState);
        }
        ...
        internal void RemoveFromSystem()
        {
            ...
            canvasPage.RemoveFromDirectedLineDict(this);
        ...
        {
            canvasPage.SetLineDesignStateAreaSelectionStatus(this, isSelected);
        }

...
namespace CanvasShapes
{
    ...
    public class CanvasDirectedPolygon : GraphicsDirectedPolygon, IAreaShape
    {
            ...
            get
            {
                if (perimeter is null)
                {
                    ...
                    foreach (GraphicsDirectedLine graphicsDirectedLine in base.Perimeter)
                    {
                        ...
                        perimeter.Add(new CanvasDirectedLine(null, graphicsDirectedLine, SystemState.DesignState));
                    }
                }
        ...
        public CanvasDirectedPolygon(CanvasWindow canvasWindow, CanvasPage canvasPage): base(canvasWindow, canvasPage)
        {
        ...
        //    List<CanvasDirectedLine> directedLineList) : base(canvasManager.Window, canvasPage)
        //{
        //    this.Guid = GuidMaintenance.CreateGuid(this);
        ...
        internal void AddAssociatedLines(GraphicsWindow window, GraphicsPage page, string lineName)
        {
            ...
            foreach (CanvasDirectedLine canvasDirectedLine in this.Perimeter)
            {
                ...
                CanvasPage.AddToDirectedLineDict(lineClonedCanvasDirectedLine);
        ...
        public CanvasDirectedPolygon(
            ...
            , string guid
            , List<CanvasDirectedLine> directedLineList)
            ...
            : base(canvasWindow, canvasPage)
        {
            ...
            canvasDirectedPolyline.ForEach(l => { perimeterList.Add(l); l.ParentPolygon = this;  canvasPage.AddToDirectedLineDict(l); });
            ...
            : this(canvasWindow, canvasPage)
        {
            ...
            foreach (GraphicsDirectedLine line in graphicsDirectedPolygon)
            {
                ...
                CanvasDirectedLine l = new CanvasDirectedLine(canvasWindow, canvasPage, lineFinishManager, line, designState,  false);
                ...
                {
                    CanvasPage.AddToDirectedLineDict(l);
                }
            }
            ...
            : base(canvasWindow, canvasPage)
        {
            ...
            {
                GraphicsDirectedLine graphicsDirectedLine = new GraphicsDirectedLine(CanvasWindow, CanvasPage, directedLine, LineRole.ExternalPerimeter);

                CanvasDirectedLine canvasDirectedLine = new CanvasDirectedLine(CanvasWindow, CanvasPage, graphicsDirectedLine, designState);
        ...
        //    , DesignState designState) : base(canvasManager.Window, canvasPage)
        //{
        //    this.canvasManager = canvasManager;

        //    foreach (DirectedLine directedLine in polygon)
        //    {
        //        GraphicsDirectedLine graphicsDirectedLine = new GraphicsDirectedLine(canvasManager.Window, canvasPage, directedLine, LineRole.ExternalPerimeter);
        ...
        private void CanvasDirectedPolygon_PerimeterLineAdded(GraphicsDirectedLine graphicsDirectedLine)
        {
            ...
            perimeter.Add(new CanvasDirectedLine(CanvasWindow, CanvasPage, lineFinishManager, graphicsDirectedLine, SystemState.DesignState));
        }
        ...
        {            
            ...
            if (CanvasPage.PageShapeDictContains(this.PolygonInternalArea.Guid))
            {
                CanvasPage.RemoveFromPageShapeDict(this.PolygonInternalArea.Guid);
            }
        }
        ...
        internal Shape CreateInternalAreaShape()
        {
            ...
            Shape = CanvasPage.DrawPolygon(coordinateArray, this.Guid);
        ...
        internal Shape CreateInternalAreaShape(string guid)
        {
            ...
            Shape = CanvasPage.DrawPolygon(coordinateArray, guid);
